...
const FreeConsultationList = () => {
  ...
  useEffect(() => {
    fetchConsultations();
  }, [currentPage, appliedSearchTerm, appliedStartDate, appliedEndDate, appliedLastEducationFilter]);
  ...
  const fetchConsultations = async () => {
    try {
      ...
      const response = await fetch(`/api/internal/freeconsulation?${params.toString()}`);
