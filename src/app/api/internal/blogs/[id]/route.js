...
export async function PUT(request, { params }) {
  try {
    ...
    console.log('🔍 PUT /api/internal/blogs - Description field:', body.description);
    console.log('🔍 PUT /api/internal/blogs - Short description field:', body.short_description);
    console.log('🔍 PUT /api/internal/blogs - Description field type:', typeof body.description);
    console.log('🔍 PUT /api/internal/blogs - Short description field type:', typeof body.short_description);
    ...
    console.log('🔍 PUT /api/internal/blogs - Description in updateData:', updateData.description);
    console.log('🔍 PUT /api/internal/blogs - Short description in updateData:', updateData.short_description);
    ...
    console.log('✅ PUT /api/internal/blogs - Blog updated successfully:', updatedBlog);
